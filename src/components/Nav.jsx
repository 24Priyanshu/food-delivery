...
function Nav() {
  ...
  return (
    <div className='w-full h-25 flex justify-between items-center px-5 md:px-8'>
      ...
      <form className='w-[45%] h-15 bg-white flex items-center px-5 gap-5 shadow-md rounded md:w-[70%]'
      ...
      <div className='w-15 h-15 bg-white flex justify-center items-center rounded-md shadow-xl relative cursor-pointer'
        onClick={() => {
          setShowCart(true)
        }}>
